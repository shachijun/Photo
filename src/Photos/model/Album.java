...
public class Album implements Comparable<Album>, Serializable {
    ...
    /**
     * Start time for date searching
     */
    private  SimpleStringProperty startTime;

    /**
     * End time for date searching
     */
    ...
    /**
     * @return Starting time for date searching
     */
    ...
    /**
     * @param startTime Starting time for date searching
     */
    ...
    /**
     * @return End time for date searching
     */
    ...
    /**
     * @param endTime End time for date searching
     */
    ...
    /**
     * @param isStore Checks whether values are initialized or not
     */
    ...
    /**
     * List of all the photos stored within an album
     */
    ...
    public Album(String _albumName, List<Photo> photoLst) {
	  ...
	  public List<SearchPhoto> Searchphotos=new ArrayList<>();

	public Album(String _albumName,List<Photo> photoLst, List<SearchPhoto> photos) {
		this(_albumName,photoLst);

		//
		for (SearchPhoto p : photos) {
			SearchPhoto newOne = new SearchPhoto(p.GetPhoto(),p.album);
			Searchphotos.add(newOne);
		}
		//
		if (photoList.size()>0) {
			indexCurrentPhoto = 0;
     ...
     * @return New index of current photo
     */
     ...
     * @return List of photos with given dates
     */
    ...
    /**
     * Sets the Date and Time for each photo
     */
