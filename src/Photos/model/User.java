...
public class User implements Comparable<User>, Serializable {
    ...
    /**
     * @param isStore Checks whether list of albums is initialized or not
     */
    ...
    /**
     * List of albums (After serialization)
     */
    ...
    /**
     * @param index Index to go through list of albums
    ...
    /**
     * @param index Index to go through list of tags
     */
    ...
    /**
     * @return List of photos within specified tags
     */
    public List<SearchPhoto> doSearchByTag() {
		List<SearchPhoto> lst = new ArrayList<>();
		//
		for (Album a : listAlbums) {
            if (!a.getAlbumName().equalsIgnoreCase(Album.ALBUM_NAME_SEARCH_BY_DATE) && !a.getAlbumName()
				...
				List<Photo> photos= a.doSearchTag(tags);
				for (Photo p :photos){
					SearchPhoto s=new SearchPhoto(p,a);
					lst.add(s);
