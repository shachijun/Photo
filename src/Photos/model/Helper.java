...
public class Helper {
     ...
     */
    public static <T extends Comparable<T>> T addOrRetrieveOrderedList(List<T> l, T element) {
        ...
        while (true) {
            ...
            if (elementInList.compareTo(element) == 0) {
                ...
                alert.setHeaderText("Same Tag and Value appears");
                alert.setContentText("Tag name and Value already exist");
                alert.showAndWait();
